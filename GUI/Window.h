...
*  --------------------
*  ver 3.4 : 06 Aug 2018
*  - added processing and display for /p option to display filenames as processed
*  ver 3.3 : 17 Sep 2017
...
using UserSettings = ref struct Settings { 
  ...
  bool sproc;                    // filename as it is processed
...
namespace CppCliWindows
{
  ref class WPFCppCliDemo : Window
  {
    ...
    CheckBox^ hSproc_ = gcnew CheckBox();
    ...
    CheckBox^ hSprocMode_ = gcnew CheckBox();
